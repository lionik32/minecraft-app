...
const texSide = loader.load('textures/grass_side_carried.png');
const texTop = loader.load('textures/grass_carried.png');
const texBottom = loader.load('textures/dirt.png');
const texStone = loader.load('textures/stone.png');
const texWood = loader.load('textures/planks_oak.png');
...
const HEAD_CLEARANCE = PLAYER_HEIGHT - EYE_HEIGHT;
...
function animate() {
    ...
    if (velocityY > 0) {
        ...
        if (ceilHits.length > 0) { velocityY = 0; }
    }
